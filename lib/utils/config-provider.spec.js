...
describe('ConfigProvider', () => {
  ...
  let configMap = {
    ...
    'boolean.default': { env: 'BOOLEAN', type: 'boolean', default: true },
    ...
    'optional': { env: 'OPTIONAL', type: 'string', optional: true },
  ...
  const validTestCases = [
    ...
    {
      name: 'should return default boolean value',
      environmentVariables: {},
      configKey: 'boolean.default',
      expectedValue: true
    },
  ...
  it('should not throw an error if a missing value is optional', () => {
    const config = new ConfigProvider(configMap, 'staging');

    expect(() => config.get('optional')).not.to.throw();
  });
});
